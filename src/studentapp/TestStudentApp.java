...
public class TestStudentApp {
    ...
    public static void main(String[] args){
        ...
        for(int i = 0; studentList!= null && i < studentList.length; i++)
        {
    ...
    public static int checkFindByName(StudentManager studentManager)
    {
        ...
        if(resultStudent!=null && resultStudent.name.equals("Student03"))
            return 3;
        else
        {
    ...
    {        
        ...
        System.out.println(resultStudent);
        if(resultStudent!=null && resultStudent.score.equals(targetScore))
            return 3;
        else
        {
